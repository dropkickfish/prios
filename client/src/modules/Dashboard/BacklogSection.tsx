...
export const BacklogSection = ({
  ...
  return (
    <div className="order-2 flex-shrink-0 flex flex-col gap-4 transition-all duration-300 w-full rounded-3xl border border-warning/20 bg-warning/5 p-3 sm:p-4">
      {backlogCollapsed ? (
        <button
          type="button"
